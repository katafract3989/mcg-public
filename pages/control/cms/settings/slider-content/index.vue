<template>
  <div>
    ...
    <div class="d-flex w-100 m-4">
      ...
      <a class="button button-primary" @click="$bvModal.show(`sliders_modal`)"
        >Create New Slide</a
      >
    </div>
    <div
        ...
        <tbody style="font-size: 18px">
          <tr>
            <td class="vertical-center">
              <img
                src="https://mtdata.ru/u9/photoCC2B/20335089593-0/original.jpg"
                width="150"
                alt=""
              />
            </td>

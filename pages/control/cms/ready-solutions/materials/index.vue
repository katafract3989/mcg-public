  ...
  <div>
    ...
    <div class="container m-3">
      <div class="row">
        ...
        >
          <AddHardware :id="`create_hardware`" @add-options="createHardware" />
          <SvgIcon name="plus" />
        </a>
        ...
        <b-form-checkbox v-model="tags" class="ml-3" name="check-button" switch>
          Tags
        </b-form-checkbox>
        <b-form-checkbox v-model="info" class="ml-3" name="check-button" switch>
          Info
        </b-form-checkbox>
      </div>
      <div class="d-flex">

  ...
  <Page :breadcrumbs="breadcrumbs">
    <!-- <template #title>
      <div class="d-flex align-items-center">
        <div class="f-32">{{ $t('pages.jobsPage.title') }}</div>
        <div class="text-primary f-22 ml-3">
          {{ $t('pages.estimatesPage.item.title', null, { id: id }) }}
        </div>
      </div>
    </template> -->
    <template #content>
            ...
            <div class="card__content d-flex flex-column">
              ...
              <div class="card__content-about d-flex flex-column">
                ...
                <div class="information">
                  ...
                  <div class="information__value">Ed Moskalenko</div>
                </div>
              ...
              <div class="d-flex justify-content-center my-3">
                ...
                >
                  {{
                    $t(
                      'pages.estimatesPage.item.details.actions.sendEstimate.title'
                    )
                  }}
                </button>
              </div>
  ...
  data() {
    return {
      breadcrumbs: [
        ...
        {
          text: this.$t('pages.jobsPage.title'),
          to: '/jobs',
        },
        {
          text: this.$t('pages.jobsPage.item.title', null, {
            id: this.id,
          }),
          active: true,
        },

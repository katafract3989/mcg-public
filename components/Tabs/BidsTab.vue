        ...
        <div class="w-100">
          <div class="input-group mb-2">
            ...
            <input
              type="text"
              class="form-control"
              :placeholder="$t('tabs.bidders.search.placeholder')"
            />
          </div>
        </div>
      </div>
            ...
            <thead>
              <tr>
                ...
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.bidsTab.content.table.fields.itemName') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.bidsTab.content.table.fields.bidder') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.bidsTab.content.table.fields.date') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.bidsTab.content.table.fields.amount') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.bidsTab.content.table.fields.signature') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.bidsTab.content.table.fields.attachmet') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.bidsTab.content.table.fields.status') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.bidsTab.content.table.fields.approve') }}
                </th>
              </tr>
            </thead>
            <tbody>

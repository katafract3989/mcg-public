        ...
        <div class="w-100">
          <div class="input-group mb-2">
            ...
            <input
              type="text"
              class="form-control"
              :placeholder="$t('tabs.biddersTab.search.placeholder')"
            />
          </div>
        </div>
      </div>
            ...
            <thead>
              <tr>
                ...
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.biddersTab.content.table.fields.subcontractor') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.biddersTab.content.table.fields.status') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.biddersTab.content.table.fields.numberBids') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{
                    $t('tabs.biddersTab.content.table.fields.reuqestLastSent')
                  }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.biddersTab.content.table.fields.sendRequest') }}
                </th>

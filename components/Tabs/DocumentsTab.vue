        ...
        <div class="w-100">
          <div class="input-group mb-2">
            ...
            <input
              type="text"
              class="form-control"
              :placeholder="$t('tabs.documentsTab.search.placeholder')"
            />
          </div>
        </div>
      </div>
            ...
            <thead>
              <tr>
                ...
                <th class="position-sticky" style="top: 0">
                  {{
                    $t('tabs.documentsTab.content.table.fields.documentName')
                  }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.documentsTab.content.table.fields.createdBy') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.documentsTab.content.table.fields.created') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{
                    $t('tabs.documentsTab.content.table.fields.subcontractor')
                  }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.documentsTab.content.table.fields.lead') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.documentsTab.content.table.fields.status') }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{ $t('tabs.documentsTab.content.table.fields.dateSend') }}
                </th>

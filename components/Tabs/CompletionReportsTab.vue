        ...
        <div class="w-100">
          <div class="input-group mb-2">
            ...
            <input
              type="text"
              class="form-control"
              :placeholder="$t('tabs.documents.search.placeholder')"
            />
          </div>
        </div>
      </div>
            ...
            <thead>
              <tr>
                ...
                <th class="position-sticky" style="top: 0">
                  {{
                    $t(
                      'tabs.completionReportsTab.content.table.fields.subcontractor'
                    )
                  }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{
                    $t(
                      'tabs.completionReportsTab.content.table.fields.dateTime'
                    )
                  }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{
                    $t('tabs.completionReportsTab.content.table.fields.notes')
                  }}
                </th>
                <th class="position-sticky" style="top: 0">
                  {{
                    $t(
                      'tabs.completionReportsTab.content.table.fields.attachments'
                    )
                  }}
                </th>
              </tr>

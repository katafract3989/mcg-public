          ...
          <div>
            ...
            <div>
              <client-only>
                ...
                >
                  <div
                    v-for="img in solution.hardware"
                    :key="img.id"
                    class="m-3"
                  >
                    <SvgIcon
          ...
          <div class="mt-2">
            ...
            <div>
              <client-only>
                ...
                >
                  <div
                    v-for="img in solution.additional"
                    :key="img.id"
                    class="m-3"
                  >
                    <SvgIcon
  ...
  methods: {
    validation() {
      if (this.data.title === undefined || this.data.title === '') {
        ...
        this.$emit('show-solution', this.solution)
    ...
    deleteOptionsItem(id) {
      this.solution.additionals.forEach((elem, i) => {
        if (elem.id === id) {
    ...
    createHardware(data) {
      this.forceRerender()
      this.solution.hardware.push(cloneDeep(data))
    },
    createOptions(data) {
      this.forceRerender()
      this.solution.additional.push(cloneDeep(data))
    },
    forceRerender() {
      this.componentKey += 1
    },
